...
static Key keys[] = {
	...
	{ MODKEY,             			    XK_u, 	   		spawn,          SHCMD("${HOME}/.local/bin/logmytime/log") },
	{ MODKEY,             			    XK_equal,  		spawn,          SHCMD("dmenucalc") },
	{ MODKEY|ShiftMask,             XK_p,   		spawn,            SHCMD("dmenupass") },
	{ MODKEY|ShiftMask,             XK_o,   		spawn,            SHCMD("copyproposal") },
	...
	{ MODKEY,                       XK_c,      		spawn,          SHCMD("useclipmenu") },
	{ MODKEY|ShiftMask,             XK_c,      		spawn,          SHCMD("toggleclipmenu") },
